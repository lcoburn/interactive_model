...
loader.load().then((geometries) => {
    ...
    window.addEventListener("resize", () => {
        // Update Sizes
        const newWidth =
            document.getElementById("model-container-2a").clientWidth - 30;
...
loader1.load().then((geometries) => {
    ...
    document.getElementById("my-gui-container-2").appendChild(gui.domElement);
    ...
    gui.add(cubeDimensions, "width", 1.5, 3.5).onChange((width) =>
        CubeUpdater.updateCubeWidth(
            cube,
    ...
    gui.add(cubeDimensions, "depth", 3, 7.7).onChange((depth) =>
...
// Renderer
const canvas = document.querySelector(".webgl-2a");
