...
loader.load().then((geometries) => {
    ...
    window.addEventListener("resize", () => {
        // Update Sizes
        const newWidth =
            document.getElementById("model-container-2b").clientWidth - 30;
...
const loader1 = new JsonGeometryLoader(
    "https://lukecoburn.s3.eu-west-2.amazonaws.com/extensions6.json"
);
...
loader1.load().then((geometries) => {
    ...
    document.getElementById("my-gui-container-3").appendChild(gui.domElement);
    ...
    gui.add(cubeDimensions, "height", 2.5, 3.2).onChange((height) =>
        CubeUpdater.updateCubeHeight(
            cube,
...
// Renderer
const canvas = document.querySelector(".webgl-2b");
