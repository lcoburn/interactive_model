...
const loader = new JsonGeometryLoader('https://lukecoburn.s3.eu-west-2.amazonaws.com/house.json');
...
loader.load().then(geometries => {
    ...
    window.addEventListener('resize',() => {
        // Update Sizes
        const newWidth = document.getElementById("model-container-1").clientWidth - 30;
...
const loader1 = new JsonGeometryLoader('https://lukecoburn.s3.eu-west-2.amazonaws.com/extensions.json');
...
loader1.load().then(geometries => {
    ...
    function updateCube() {
        ...
        // create new geometry
        let newGeometry = new THREE.BoxGeometry(cubeDimensions.width, cubeDimensions.height, cubeDimensions.depth); // adjust width and height as per your requirements
